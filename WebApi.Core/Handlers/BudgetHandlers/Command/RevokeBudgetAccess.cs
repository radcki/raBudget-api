    ...
    public class RevokeBudgetAccess
    {
        ...
        public class Validator : AbstractValidator<Request>
        {
            public Validator()
            {
                ...
                RuleFor(x => x.AllowedUser).NotEmpty();
            }
        }
        ...
        public class Handler : BaseBudgetHandler<Request, Response>
        {
            ...
            {
                var findShareTask = _budgetShareRepository.ListWithFilter(new Budget(request.BudgetId),
                                                                          new BudgetShareFilterModel()
                                                                          {
                                                                              UserIdFilter = request.AllowedUser.UserId
                                                                          });
